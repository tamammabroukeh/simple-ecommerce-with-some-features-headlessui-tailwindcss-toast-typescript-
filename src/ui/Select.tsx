...
import { ISelectorValue } from "../interfaces/Interfaces";

const classNames = (...classes: string[]) => {
  return classes.filter(Boolean).join(" ");
};

const Select = ({ selected, setSelected }: ISelectorValue) => {
  ...
  return (
    <Listbox value={selected} onChange={setSelected}>
      {({ open }) => (
        <>
          <Listbox.Label className="block font-medium text-md font-bold text-gray-900">
            Category
          </Listbox.Label>
